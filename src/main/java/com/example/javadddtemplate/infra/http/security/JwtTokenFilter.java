package com.example.javadddtemplate.infra.http.security;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    public JwtTokenFilter(JwtTokenUtil jwtTokenUtil, GetUserByEmailRepositoryInterface repository) {
    ...
    private Optional<UserDetails> getUserDetails(String token) {
        ...
        try {
            var user = repository.execute(email);
            if (user.isEmpty()) {
